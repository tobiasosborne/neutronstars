...
export MagneticFF, cyclotron_freq_e, cyclotron_freq_p, sigma_ff_alpha, sigma_pp_alpha
export sigma_scat_alpha, sigma_total_alpha
export MagneticModes, rosseland_magnetic, mode_absorption, mode_scattering
