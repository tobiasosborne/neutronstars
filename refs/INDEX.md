...
All files checksummed in `CHECKSUMS` (SHA-256).
...
| haakonsen_2012 | `haakonsen_2012_mcphac.pdf` | Haakonsen et al., ApJ 749, 52 (2012); arXiv:1111.4405 | McPHAC: B=0 verification benchmark, numerical scheme (Feautrier method) |
| pechenick_1983 | `pechenick_1983_gr_ray_tracing.pdf` | Pechenick, Ftaclas & Cohen, ApJ 274, 846 (1983) | Exact Schwarzschild ray tracing, elliptic integral formulae |
| beloborodov_2002 | `beloborodov_2002_ray_tracing.pdf` | Beloborodov, ApJ 566, L85 (2002); arXiv:astro-ph/0201117 | Simplified + exact GR ray tracing formulae, benchmarks |
| dexter_agol_2009 | `dexter_agol_2009_kerr.pdf` | Dexter & Agol, ApJ 696, 1616 (2009); arXiv:0903.0507 | Kerr geodesic integration |
...
| Bibkey | File | Reference | Used for |
|--------|------|-----------|----------|
| ruder_1994 | `ruder_1994_atoms_strong_B.pdf` | Ruder et al., "Atoms in Strong Magnetic Fields" (1994) Springer, ISBN 3-540-57499-0 | Energy levels, oscillator strengths, wavefunctions in strong B |

## Books (manual download required)

| Bibkey | ISBN | Reference | Chapters needed | Used for |
|--------|------|-----------|-----------------|----------|
| meszaros_1992 | 0-226-52094-4 | Mészáros, "High-Energy Radiation from Magnetized Neutron Stars" (1992) U. Chicago Press | Ch 3–5 | Polarisation-dependent scattering cross-sections, normal modes |
| mihalas_1978 | 0-7167-0359-9 | Mihalas, "Stellar Atmospheres" 2nd ed (1978) Freeman | Ch 6 | Feautrier method, ALI, temperature correction |
| rybicki_lightman_1979 | 0-471-82759-2 | Rybicki & Lightman, "Radiative Processes in Astrophysics" (1979) Wiley | Ch 1, 5, 7 | Planck function, Kramers/bremsstrahlung, Kompaneets equation |
| shapiro_teukolsky_1983 | 0-471-87316-0 | Shapiro & Teukolsky, "Black Holes, White Dwarfs, and Neutron Stars" (1983) Wiley | Ch 5–6 | TOV equation, NS structure |

**Note:** Wiley books blocked by Cloudflare Turnstile in headless mode. TIB VPN access confirmed (book landing pages load). Download manually via browser.
...
|-----------|--------|----------|
| `code/McPHAC/` | github.com/McPHAC/McPHAC | B=0 atmosphere structural reference + verification target |

## Standards (not downloadable as PDF)

| Reference | Used for |
|-----------|----------|
| IEC 61966-2-1:1999 | XYZ → sRGB conversion matrix, gamma curve |
| CIE 015:2004 | Colorimetric observers (covered by CVRL data above) |
